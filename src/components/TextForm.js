        ...
        <div className='container my-2' style={
            ...
            <div className="mb-3">
                ...
                <textarea className="form-control" onChange={change} value={text} id="mytext" rows="8" style={
                 {backgroundColor: props.mode==='light'?'white':'gray', color: props.mode==='light'?'black':'white'}   
                }></textarea>
            </div>
            ...
            <button className='btn btn-success' onClick={cclick}>Clear text</button>
            <button className='btn btn-warning mx-1' onClick={clclick}>Copy to clip</button>
            <button className='btn btn-danger' onClick={rclick}>Remove Extra Spaces</button>
        </div>
